 ...
 */
final class Version20240104133557 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD episode_id INT DEFAULT NULL, ADD author_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP episode_id, DROP author_id');
    }
}
